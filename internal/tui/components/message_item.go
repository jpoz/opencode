...
// View renders a single message string with a sender prefix and styling.
// sender: The string to display as the sender (e.g., "You", "Bot").
// content: The actual message text.
// availableWidth: The total width the message item can occupy.
